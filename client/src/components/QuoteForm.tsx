    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description:
            "Thank you! We've received your quote request and will get back to you within 24 hours.",
          duration: 5000,
        });
    ...
    <div className="min-h-screen py-20 bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="hover-elevate">
          <CardHeader>
            <CardTitle className="text-2xltext-primary">
              Quote Request Form
            </CardTitle>
            <CardDescription>
              Please provide your details and service requirements. We'll get
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Holiday Homes Cleaning">
