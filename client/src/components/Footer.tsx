            ...
            <div className="flex md:flex-row flex-col gap-2 ">
              <div className="md:w-1/4">
                <Link
                  ...
                  <div className="bg-white/30 backdrop-blur-sm rounded-lg p-2 border border-white/20 shadow-lg hover-lift w-full flex items-center justify-center">
                    <img
                      src={logo}
              ...
              <div className="md:w-3/4">
                <p className="text-primary-foreground/80 text-sm leading-relaxed">
                  Dubai's most luxurious cleaning services. Boutique cleaning
                  company delivering hospitality-level service with unmatched
                  attention to detail.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              <li>
                <Link href="/services">
                  <span
                    className="hover:text-ring transition-colors cursor-pointer"
                    data-testid="link-commercial-cleaning"
                  >
              ...
              <li>
                <Link href="/services">
                  <span
                    className="hover:text-ring transition-colors cursor-pointer"
                    data-testid="link-residential-cleaning"
                  >
                    The Regular Refresh
                  </span>
                </Link>
              ...
              <li>
                <Link href="/services">
                  <span
                    className="hover:text-ring transition-colors cursor-pointer"
                    data-testid="link-airbnb-cleaning"
                  >
              ...
              <li>
                <Link href="/services">
                  <span
                    className="hover:text-ring transition-colors cursor-pointer"
                    data-testid="link-deep-cleaning"
                  >
                    The Complete Clean
                  </span>
                </Link>
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center justify-center md:justify-start space-x-2 text-primary-foreground/80">
                ...
                <a
                  href="mailto:admin@freshendeluxe.com"
                  className="hover:text-ring transition-colors"
                >
                  ...
                  onClick={() =>
                    window.open(
                      `https://wa.me/971554360800?text=${encodeURIComponent(
                        "Hello! I would like to get a quote for Freshen Deluxe cleaning services."
                      )}`,
                      "_blank",
                      "noopener,noreferrer"
                    )
